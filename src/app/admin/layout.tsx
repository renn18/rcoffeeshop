...
const Header: React.FC<HeaderProps> = ({ toggleSidebar, activePath }) => {
    // Mengambil judul halaman dari state activePath
    const pageTitle = activePath.split('/').pop();
        ...
        <div className="bg-gray-50 min-h-screen font-sans text-gray-900">
            <div className="flex">
                ...
                <main className="flex-1 transition-all duration-300">
                    <Header toggleSidebar={toggleSidebar} activePath={activePath} />
